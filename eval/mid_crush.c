 ...
 */
{
  ...
  }
  {
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      smarsa_BirthdaySpacings(gen, res, 200, 4 * MILLION / 10, 0, 67108864, 2,
                              1);
      bbattery_pVal[++j] = res->pVal2;
      TestNumber[j] = j2;
      strcpy(bbattery_TestNames[j], "BirthdaySpacings, t = 2");
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      smarsa_BirthdaySpacings(gen, res, 200, 4 * MILLION / 10, 0, 1024 * 8, 4,
                              1);
      bbattery_pVal[++j] = res->pVal2;
      TestNumber[j] = j2;
      strcpy(bbattery_TestNames[j], "BirthdaySpacings, t = 4");
  ...
  }
  {
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      svaria_AppearanceSpacings(gen, res, 1, 10 * MILLION, 400 * MILLION, r, 30,
                                15);
      bbattery_pVal[++j] = res->pVal2[gofw_Mean];
      TestNumber[j] = j2;
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      svaria_AppearanceSpacings(gen, res, 1, 10 * MILLION, 100 * MILLION, 20,
                                10, 15);
      bbattery_pVal[++j] = res->pVal2[gofw_Mean];
      TestNumber[j] = j2;
  ...
  bbattery_NTests = ++j;
  GetName(gen, genName);
  WriteReport(genName, "Crush", bbattery_NTests, bbattery_pVal, Timer, FALSE,
              TRUE, 0.0);
  chrono_Delete(Timer);
}
 ...
 */
{
  ...
  }
  {
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      smarsa_BirthdaySpacings(gen, res, 10 * THOUSAND, MILLION / 10, 0, 16, 13,
                              1);
      bbattery_pVal[++j] = res->pVal2;
      TestNumber[j] = j2;
      strcpy(bbattery_TestNames[j], "BirthdaySpacings, t = 13");
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      smarsa_BirthdaySpacings(gen, res, 10 * THOUSAND, MILLION / 10, 5, 16, 13,
                              1);
      bbattery_pVal[++j] = res->pVal2;
      TestNumber[j] = j2;
      strcpy(bbattery_TestNames[j], "BirthdaySpacings, t = 13");
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      smarsa_BirthdaySpacings(gen, res, 10 * THOUSAND, MILLION / 10, 10, 16, 13,
                              1);
      bbattery_pVal[++j] = res->pVal2;
      TestNumber[j] = j2;
      strcpy(bbattery_TestNames[j], "BirthdaySpacings, t = 13");
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      smarsa_BirthdaySpacings(gen, res, 10 * THOUSAND, MILLION / 10, 15, 16, 13,
                              1);
      bbattery_pVal[++j] = res->pVal2;
      TestNumber[j] = j2;
      strcpy(bbattery_TestNames[j], "BirthdaySpacings, t = 13");
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      smarsa_BirthdaySpacings(gen, res, 10 * THOUSAND, MILLION / 10, 20, 16, 13,
                              1);
      bbattery_pVal[++j] = res->pVal2;
      TestNumber[j] = j2;
      strcpy(bbattery_TestNames[j], "BirthdaySpacings, t = 13");
    ...
    ++j2;
    for (i = 0; i < Rep[j2]; ++i) {
      smarsa_BirthdaySpacings(gen, res, 10 * THOUSAND, MILLION / 10, 26, 16, 13,
                              1);
      bbattery_pVal[++j] = res->pVal2;
      TestNumber[j] = j2;
      strcpy(bbattery_TestNames[j], "BirthdaySpacings, t = 13");
  ...
  bbattery_NTests = ++j;
  GetName(gen, genName);
  WriteReport(genName, "BigCrush", bbattery_NTests, bbattery_pVal, Timer, FALSE,
              TRUE, 0.0);
  chrono_Delete(Timer);
}
...
static void Alphabit(unif01_Gen *gen, char *fname, double nb, int r, int s,
  ...
  if (fileFlag) {
    WriteReport(fname, "Alphabit", bbattery_NTests, bbattery_pVal, Timer, TRUE,
                TRUE, nb);
    ufile_DeleteReadBin(gen);
  } else {
    GetName(gen, genName);
    WriteReport(genName, "Alphabit", bbattery_NTests, bbattery_pVal, Timer,
                FALSE, TRUE, nb);
  }
 ...
 */
{
  ...
  bbattery_NTests = ++j;
  if (fileFlag) {
    WriteReport(fname, "Rabbit", bbattery_NTests, bbattery_pVal, Timer, TRUE,
                TRUE, nb);
    ufile_DeleteReadBin(gen);
  } else {
    GetName(gen, genName);
    WriteReport(genName, "Rabbit", bbattery_NTests, bbattery_pVal, Timer, FALSE,
                TRUE, nb);
  }
  chrono_Delete(Timer);
}
...
static void
WriteReportFIPS_140_2(char *genName, /* Generator or file name */
                      lebool Flag,   /* = TRUE for a file, FALSE for a gen */
...
static void FIPS_140_2(unif01_Gen *gen, char *filename) {
  ...
  WriteReportFIPS_140_2(genName, fileFlag, nbit, longest0, longest1, nrun0,
                        nrun1, ncount);
}
